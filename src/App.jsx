  ...
  return (
    <>
      <header>
        ...
        >
          <input className='search' name='search' onChange={handleChange} value={search} placeholder='Avengers, Star Wars, etc'></input>
          <div className='form-div'>
            <label>ordenar de alfabeticamente</label>
            <input className='checkbox' type="checkbox" onChange={handleSort} checked={sort}></input>
